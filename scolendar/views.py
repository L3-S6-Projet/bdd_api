...
from scolendar.viewsets.profile_viewsets import ProfileViewSet, ProfileLastOccupancyEdit, ProfileNextOccupancy, \
    ProfileICalFeed
...
profile_next_occupancy = ProfileNextOccupancy.as_view()
